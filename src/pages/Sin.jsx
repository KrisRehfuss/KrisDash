...
import Drop from "../../public/AI/Orbs/FlowerSolo.png";

import Art1 from "../../public/AI/Orbs/FlowerSun.png";
import Art2 from "../../public/AI/Orbs/MechaOrb-1.png";
import Art3 from "../../public/AI/Orbs/MechaOrb-2.png";
import Art4 from "../../public/AI/Orbs/EarthMechII-4.png";
import Art5 from "../../public/AI/Orbs/MechaOrbII-1.png";
...
import A1 from "../../public/Piano/Kinetic/Sin-001.mp3";
import A2 from "../../public/Piano/Kinetic/Sin-002.mp3";
import A3 from "../../public/Piano/Kinetic/Sin-003.mp3";
import A4 from "../../public/Piano/Kinetic/Sin-004.mp3";
import A5 from "../../public/Piano/Kinetic/Sin-005.mp3";
import A6 from "../../public/Piano/Kinetic/Sin-006.mp3";
import A7 from "../../public/Piano/Kinetic/Sin-007.mp3";
import A8 from "../../public/Piano/Kinetic/Sin-008.mp3";
import A9 from "../../public/Piano/Kinetic/Sin-009.mp3";

import R1 from "../../public/Piano/Kinetic/SinHi-001.mp3";
import R2 from "../../public/Piano/Kinetic/SinHi-002.mp3";
import R3 from "../../public/Piano/Kinetic/SinHi-003.mp3";
import R4 from "../../public/Piano/Kinetic/SinHi-004.mp3";
import R5 from "../../public/Piano/Kinetic/SinHi-005.mp3";
import R6 from "../../public/Piano/Kinetic/SinHi-006.mp3";
import R7 from "../../public/Piano/Kinetic/SinHi-007.mp3";
import R8 from "../../public/Piano/Kinetic/SinHi-008.mp3";
import R9 from "../../public/Piano/Kinetic/SinHi-009.mp3";
   ...
   return (
      <div>
         <Head>
            ...
            <meta name="description" content="Sin" />
            <meta
               name="viewport"
         ...
         <main className="SinWrapper h-fit Smoother ">
            ...
            <div 
               ...
               {/* Links */}
               <div className="xl:pr-48 lg:pr-16 flex gap-4 w-fit items-center justify-end text-white dark:text-white h-full">
               ...
               <div className="FlexCenterCol h-fit p-2 w-fit md:w-7/12 lg:w-10/12 xl:w-8/12">
                  ...
                  <div className=" w-full mx-4 px-4 mt-2 md:mb-6 mb-2">
                     ...
                     <Header style="
                        ...
                        xl:w-fit xl:ml-[1000px] xl:inline-block  xl:text-9xl 
                        xl:dark:hidden     
                        lg:hidden lg:-mt-64 lg:text-9xl lg:text-right lg:ml-[400px]

                        text-5xl w-fit NameShadow hover:text-white cursor-text SinText font-extrabold text-center Smoother antialiased " 
                  text='Sin' />
