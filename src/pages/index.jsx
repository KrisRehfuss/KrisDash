    ...
    <>
      ...
      <main>
        ...
        <div className=" FlexCenterCol mt-8 font-pop BoxScreen">
          <div className=" FlexCenterCol p-2  h-fit min-h-fit w-full">
            {/* Header */}
            <h1 className=" cursor-text text-gray-300 text-4xl font-extrabold text-center">
            ...
            <button className="w-full py-2 p-2 Shadow rounded-3xl font-semibold text-xl text-gray-200 bg-indigo-700 ">
              Explore All
            </button>

            <button className="flex items-center w-full mt-3 p-3 px-4 Shadow rounded-3xl text-left font-extralight text-sm text-gray-400 bg-gray-700 bg-opacity-50 ">
